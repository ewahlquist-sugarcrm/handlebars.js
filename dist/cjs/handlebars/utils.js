...
exports.isEmpty = isEmpty;function createFrame(object) {
  var frame = extend({}, object);
  frame._parent = object;
  return frame;
}

exports.createFrame = createFrame;function appendContextPath(contextPath, id) {
  return (contextPath ? contextPath + '.' : '') + id;
}

exports.appendContextPath = appendContextPath;function isPropertySafe(name) {
...
exports.isPropertySafe = isPropertySafe;